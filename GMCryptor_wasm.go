...
func jsSM4EcbEncrypt(this js.Value, args []js.Value) interface{} {
	rt := SM4EcbEncrypt(args[0].String(), args[1].String())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM4EcbDecrypt(this js.Value, args []js.Value) interface{} {
	rt := SM4EcbDecrypt(args[0].String(), args[1].String())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM4CbcEncrypt(this js.Value, args []js.Value) interface{} {
	rt := SM4CbcEncrypt(args[0].String(), args[1].String(), args[2].String())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM4CbcDecrypt(this js.Value, args []js.Value) interface{} {
	rt := SM4CbcDecrypt(args[0].String(), args[1].String(), args[2].String())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM2DecryptAsn1(this js.Value, args []js.Value) interface{} {
	rt := SM2DecryptAsn1(args[0].String(), args[1].String())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM2EncryptAsn1(this js.Value, args []js.Value) interface{} {
	rt := SM2EncryptAsn1(args[0].String(), args[1].String())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM2Decrypt(this js.Value, args []js.Value) interface{} {
	rt := SM2Decrypt(args[0].String(), args[1].String(), args[2].Int())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM2Encrypt(this js.Value, args []js.Value) interface{} {
	rt := SM2Encrypt(args[0].String(), args[1].String(), args[2].Int())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM2Signature(this js.Value, args []js.Value) interface{} {
	rt := SM2Signature(args[0].String(), args[1].String())
	if rt == "" {
		return nil
	} else {
		return rt
...
func jsSM2VerifySign(this js.Value, args []js.Value) interface{} {
	return SM2VerifySign(args[0].String(), args[1].String(), args[2].String())
}

func jsCipherUnmarshal(this js.Value, args []js.Value) interface{} {
	rt := CipherUnmarshal(args[0].String(), args[1].Int())
	if rt == "" {
		return nil
	} else {
		return rt
